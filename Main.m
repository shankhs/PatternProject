...
[errorRate,baselineErrorRate,baselineStd]=Run(initData,classLabels,initTestIntData,initTestIntLabel,MAX_DIM,PARTITION,REPEAT,0,0)
...
% knnErrorRate = RunKnnc(initData,classLabels,initTestIntData,initTestIntLabel);
% dlmwrite(knnErrorRate,'knnErrorRate.txt');
% DrawPlot(knnErrorRate,'knnErrorPlot');
% -----------------------------------------------------------------------------------------------
%run ldc
% -----------------------------------------------------------------------------------------------
% fprintf('Now running ldc')
% ldcErrorRate = RunLdc(initData,classLabels,initTestIntData,initTestIntLabel);
% dlmwrite(ldcErrorRate,'ldcErrorRate.txt');
